...
#ifndef RTW_HEADER_Identification_G_h_
#define RTW_HEADER_Identification_G_h_
#ifndef Identification_G_COMMON_INCLUDES_
#define Identification_G_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* Identification_G_COMMON_INCLUDES_ */
...
#define Identification_G_rtModel       RT_MODEL_Identification_G_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Omegamoteur_PWORK;                 /* '<Root>/Omega moteur' */
...
} DW_Identification_G_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Identification_G_B
#define BlockIO                        B_Identification_G_T
#define rtP                            Identification_G_P
#define Parameters                     P_Identification_G_T
#define rtDWork                        Identification_G_DW
#define D_Work                         DW_Identification_G_T

/* Parameters (default storage) */
struct P_Identification_G_T_ {
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: 10.0
                                        * Referenced by: '<Root>/Step'
                                        */
...
struct tag_RTM_Identification_G_T {
  const char_T *path;
...
extern P_Identification_G_T Identification_G_P;

/* Block signals (default storage) */
extern B_Identification_G_T Identification_G_B;

/* Block states (default storage) */
extern DW_Identification_G_T Identification_G_DW;

/* Model entry point functions */
extern void Identification_G_initialize(void);
extern void Identification_G_output(void);
extern void Identification_G_update(void);
extern void Identification_G_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Identification_G_rtModel *Identification_G(void);
...
extern RT_MODEL_Identification_G_T *const Identification_G_M;
 ...
 *
 * '<Root>' : 'Identification_G'
 * '<S1>'   : 'Identification_G/Quanser Aero USB Interface'
 * '<S2>'   : 'Identification_G/Radians to Degrees2'
 * '<S3>'   : 'Identification_G/Signal Builder'
 * '<S4>'   : 'Identification_G/Quanser Aero USB Interface/Base LED Colour'
 */
#endif                                 /* RTW_HEADER_Identification_G_h_ */
