...
COMPILER_COMMAND_FILE     = Identification_F_comp.rsp
CMD_FILE                  = Identification_F.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Identification_F.rt-win64
...
DEFINES_STANDARD = -DMODEL=Identification_F -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Identification_F_quarc_win64\Identification_F.c $(START_DIR)\Identification_F_quarc_win64\Identification_F_data.c $(START_DIR)\Identification_F_quarc_win64\Identification_F_main.c $(START_DIR)\Identification_F_quarc_win64\rtGetInf.c $(START_DIR)\Identification_F_quarc_win64\rtGetNaN.c $(START_DIR)\Identification_F_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Identification_F.obj Identification_F_data.obj Identification_F_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Identification_F_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Identification_F_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Identification_F.obj : "$(START_DIR)\Identification_F_quarc_win64\Identification_F.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_F_quarc_win64\Identification_F.c"


Identification_F_data.obj : "$(START_DIR)\Identification_F_quarc_win64\Identification_F_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_F_quarc_win64\Identification_F_data.c"


Identification_F_main.obj : "$(START_DIR)\Identification_F_quarc_win64\Identification_F_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_F_quarc_win64\Identification_F_main.c"


rtGetInf.obj : "$(START_DIR)\Identification_F_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_F_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Identification_F_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_F_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Identification_F_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_F_quarc_win64\rt_nonfinite.c"
