...
#ifndef RTW_HEADER_Implantation_Cmd_LQGI_h_
#define RTW_HEADER_Implantation_Cmd_LQGI_h_
#ifndef Implantation_Cmd_LQGI_COMMON_INCLUDES_
#define Implantation_Cmd_LQGI_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                              /* Implantation_Cmd_LQGI_COMMON_INCLUDES_ */

#include "Implantation_Cmd_LQGI_types.h"
...
#define Implantation_Cmd_LQGI_rtModel  RT_MODEL_Implantation_Cmd_LQG_T
...
} DW_Implantation_Cmd_LQGI_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} X_Implantation_Cmd_LQGI_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} XDot_Implantation_Cmd_LQGI_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
} XDis_Implantation_Cmd_LQGI_T;
...
#define rtB                            Implantation_Cmd_LQGI_B
#define BlockIO                        B_Implantation_Cmd_LQGI_T
#define rtX                            Implantation_Cmd_LQGI_X
#define ContinuousStates               X_Implantation_Cmd_LQGI_T
#define rtXdot                         Implantation_Cmd_LQGI_XDot
#define StateDerivatives               XDot_Implantation_Cmd_LQGI_T
#define tXdis                          Implantation_Cmd_LQGI_XDis
#define StateDisabled                  XDis_Implantation_Cmd_LQGI_T
#define rtP                            Implantation_Cmd_LQGI_P
#define Parameters                     P_Implantation_Cmd_LQGI_T
#define rtDWork                        Implantation_Cmd_LQGI_DW
#define D_Work                         DW_Implantation_Cmd_LQGI_T

/* Parameters (default storage) */
struct P_Implantation_Cmd_LQGI_T_ {
...
struct tag_RTM_Implantation_Cmd_LQGI_T {
  const char_T *path;
...
extern P_Implantation_Cmd_LQGI_T Implantation_Cmd_LQGI_P;

/* Block signals (default storage) */
extern B_Implantation_Cmd_LQGI_T Implantation_Cmd_LQGI_B;

/* Continuous states (default storage) */
extern X_Implantation_Cmd_LQGI_T Implantation_Cmd_LQGI_X;

/* Block states (default storage) */
extern DW_Implantation_Cmd_LQGI_T Implantation_Cmd_LQGI_DW;
...
extern void Implantation_Cmd_LQGI_initialize(void);
extern void Implantation_Cmd_LQGI_output0(void);
extern void Implantation_Cmd_LQGI_update0(void);
extern void Implantation_Cmd_LQGI_output2(void);
extern void Implantation_Cmd_LQGI_update2(void);
extern void Implantation_Cmd_LQGI_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Implantation_Cmd_LQGI_rtModel *Implantation_Cmd_LQGI(void);
...
extern RT_MODEL_Implantation_Cmd_LQG_T *const Implantation_Cmd_LQGI_M;
 ...
 *
 * '<Root>' : 'Implantation_Cmd_LQGI'
 * '<S1>'   : 'Implantation_Cmd_LQGI/Quanser Aero USB Interface'
 * '<S2>'   : 'Implantation_Cmd_LQGI/Radians to Degrees2'
 * '<S3>'   : 'Implantation_Cmd_LQGI/Retour etat w'
 * '<S4>'   : 'Implantation_Cmd_LQGI/Quanser Aero USB Interface/Base LED Colour'
 */
#endif                                 /* RTW_HEADER_Implantation_Cmd_LQGI_h_ */
