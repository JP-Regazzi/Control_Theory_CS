###########################################################################
## Makefile generated for component 'Implantation_Cmd_LQGI'. 
## 
## Makefile     : Implantation_Cmd_LQGI.mk
## Generated on : Thu Oct 19 12:45:24 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Implantation_Cmd_LQGI.rt-win64
...
PRODUCT_NAME              = Implantation_Cmd_LQGI
MAKEFILE                  = Implantation_Cmd_LQGI.mk
...
COMPILER_COMMAND_FILE     = Implantation_Cmd_LQGI_comp.rsp
CMD_FILE                  = Implantation_Cmd_LQGI.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Implantation_Cmd_LQGI.rt-win64
...
DEFINES_STANDARD = -DMODEL=Implantation_Cmd_LQGI -DNUMST=3 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI.c $(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI_data.c $(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI_main.c $(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rtGetInf.c $(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rtGetNaN.c $(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Implantation_Cmd_LQGI.obj Implantation_Cmd_LQGI_data.obj Implantation_Cmd_LQGI_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Implantation_Cmd_LQGI.obj : "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI.c"


Implantation_Cmd_LQGI_data.obj : "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI_data.c"


Implantation_Cmd_LQGI_main.obj : "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\Implantation_Cmd_LQGI_main.c"


rtGetInf.obj : "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_LQGI_quarc_win64\rt_nonfinite.c"
