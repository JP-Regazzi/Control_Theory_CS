...
typedef RT_MODEL_Implantation_Cmd_LQG_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Implantation_Cmd_LQGI(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Implantation_Cmd_LQGI_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Implantation_Cmd_LQGI -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
