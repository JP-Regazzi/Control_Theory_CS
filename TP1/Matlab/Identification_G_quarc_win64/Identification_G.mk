###########################################################################
## Makefile generated for component 'Identification_G'. 
## 
## Makefile     : Identification_G.mk
## Generated on : Fri Sep 22 08:51:00 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Identification_G.rt-win64
...
COMPILER_COMMAND_FILE     = Identification_G_comp.rsp
CMD_FILE                  = Identification_G.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Identification_G.rt-win64
...
DEFINES_STANDARD = -DMODEL=Identification_G -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Identification_G_quarc_win64\Identification_G.c $(START_DIR)\Identification_G_quarc_win64\Identification_G_data.c $(START_DIR)\Identification_G_quarc_win64\Identification_G_main.c $(START_DIR)\Identification_G_quarc_win64\rtGetInf.c $(START_DIR)\Identification_G_quarc_win64\rtGetNaN.c $(START_DIR)\Identification_G_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Identification_G.obj Identification_G_data.obj Identification_G_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Identification_G_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Identification_G_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Identification_G.obj : "$(START_DIR)\Identification_G_quarc_win64\Identification_G.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_G_quarc_win64\Identification_G.c"


Identification_G_data.obj : "$(START_DIR)\Identification_G_quarc_win64\Identification_G_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_G_quarc_win64\Identification_G_data.c"


Identification_G_main.obj : "$(START_DIR)\Identification_G_quarc_win64\Identification_G_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_G_quarc_win64\Identification_G_main.c"


rtGetInf.obj : "$(START_DIR)\Identification_G_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_G_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Identification_G_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_G_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Identification_G_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Identification_G_quarc_win64\rt_nonfinite.c"
