...
#ifndef RTW_HEADER_Implantation_Cmd_LQ_h_
#define RTW_HEADER_Implantation_Cmd_LQ_h_
#ifndef Implantation_Cmd_LQ_COMMON_INCLUDES_
#define Implantation_Cmd_LQ_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                /* Implantation_Cmd_LQ_COMMON_INCLUDES_ */

#include "Implantation_Cmd_LQ_types.h"
...
#define Implantation_Cmd_LQ_rtModel    RT_MODEL_Implantation_Cmd_LQ_T
...
typedef struct {
  ...
  real_T theta_refdegrs;               /* '<Root>/Add4' */
  real_T Gain;                         /* '<S2>/Gain' */
} B_Implantation_Cmd_LQ_T;
...
} DW_Implantation_Cmd_LQ_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Implantation_Cmd_LQ_B
#define BlockIO                        B_Implantation_Cmd_LQ_T
#define rtP                            Implantation_Cmd_LQ_P
#define Parameters                     P_Implantation_Cmd_LQ_T
#define rtDWork                        Implantation_Cmd_LQ_DW
#define D_Work                         DW_Implantation_Cmd_LQ_T

/* Parameters (default storage) */
struct P_Implantation_Cmd_LQ_T_ {
...
struct tag_RTM_Implantation_Cmd_LQ_T {
  const char_T *path;
...
extern P_Implantation_Cmd_LQ_T Implantation_Cmd_LQ_P;

/* Block signals (default storage) */
extern B_Implantation_Cmd_LQ_T Implantation_Cmd_LQ_B;

/* Block states (default storage) */
extern DW_Implantation_Cmd_LQ_T Implantation_Cmd_LQ_DW;
...
extern void Implantation_Cmd_LQ_initialize(void);
extern void Implantation_Cmd_LQ_output0(void);
extern void Implantation_Cmd_LQ_update0(void);
extern void Implantation_Cmd_LQ_output2(void);
extern void Implantation_Cmd_LQ_update2(void);
extern void Implantation_Cmd_LQ_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Implantation_Cmd_LQ_rtModel *Implantation_Cmd_LQ(void);
...
extern RT_MODEL_Implantation_Cmd_LQ_T *const Implantation_Cmd_LQ_M;
 ...
 *
 * '<Root>' : 'Implantation_Cmd_LQ'
 * '<S1>'   : 'Implantation_Cmd_LQ/Quanser Aero USB Interface'
 * '<S2>'   : 'Implantation_Cmd_LQ/Radians to Degrees2'
 * '<S3>'   : 'Implantation_Cmd_LQ/Retour etat w'
 * '<S4>'   : 'Implantation_Cmd_LQ/Quanser Aero USB Interface/Base LED Colour'
 */
#endif                                 /* RTW_HEADER_Implantation_Cmd_LQ_h_ */
