...
typedef RT_MODEL_Implantation_Cmd_LQI_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Implantation_Cmd_LQI(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Implantation_Cmd_LQI_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Implantation_Cmd_LQI -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
