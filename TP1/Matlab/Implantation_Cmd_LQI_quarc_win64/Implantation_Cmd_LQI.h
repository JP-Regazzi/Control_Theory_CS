...
#ifndef RTW_HEADER_Implantation_Cmd_LQI_h_
#define RTW_HEADER_Implantation_Cmd_LQI_h_
#ifndef Implantation_Cmd_LQI_COMMON_INCLUDES_
#define Implantation_Cmd_LQI_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                               /* Implantation_Cmd_LQI_COMMON_INCLUDES_ */

#include "Implantation_Cmd_LQI_types.h"
...
#define Implantation_Cmd_LQI_rtModel   RT_MODEL_Implantation_Cmd_LQI_T

/* Block signals (default storage) */
typedef struct {
  real_T HILRead_o1;                   /* '<S1>/HIL Read' */
  real_T HILRead_o2;                   /* '<S1>/HIL Read' */
  real_T omega_ref;                    /* '<Root>/Rate Transition1' */
  ...
  real_T theta_refdegrs_k;             /* '<Root>/Add4' */
  real_T Gain;                         /* '<S2>/Gain' */
} B_Implantation_Cmd_LQI_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay1_DSTATE;            /* '<S3>/Unit Delay1' */
  real_T UnitDelay_DSTATE;             /* '<S3>/Unit Delay' */
  real_T DiscreteFilter2_states;       /* '<Root>/Discrete Filter2' */
  ...
  real_T DiscreteFilter2_tmp;          /* '<Root>/Discrete Filter2' */
  ...
  struct {
    void *LoggedData;
  } omegapitch_PWORK;                  /* '<Root>/omega pitch' */
...
} DW_Implantation_Cmd_LQI_T;

/* Continuous states (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} X_Implantation_Cmd_LQI_T;

/* State derivatives (default storage) */
typedef struct {
  real_T Integrator_CSTATE;            /* '<Root>/Integrator' */
} XDot_Implantation_Cmd_LQI_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE;         /* '<Root>/Integrator' */
} XDis_Implantation_Cmd_LQI_T;
...
#define rtB                            Implantation_Cmd_LQI_B
#define BlockIO                        B_Implantation_Cmd_LQI_T
#define rtX                            Implantation_Cmd_LQI_X
#define ContinuousStates               X_Implantation_Cmd_LQI_T
#define rtXdot                         Implantation_Cmd_LQI_XDot
#define StateDerivatives               XDot_Implantation_Cmd_LQI_T
#define tXdis                          Implantation_Cmd_LQI_XDis
#define StateDisabled                  XDis_Implantation_Cmd_LQI_T
#define rtP                            Implantation_Cmd_LQI_P
#define Parameters                     P_Implantation_Cmd_LQI_T
#define rtDWork                        Implantation_Cmd_LQI_DW
#define D_Work                         DW_Implantation_Cmd_LQI_T

/* Parameters (default storage) */
struct P_Implantation_Cmd_LQI_T_ {
  real_T K_lqi[3];                     /* Variable: K_lqi
                                        * Referenced by:
                                        *   '<Root>/Gain4'
                                        *   '<Root>/Gain5'
                                        */
  ...
  real_T TmpRTBAtIntegratorInport1_Initi;/* Expression: 0
                                          * Referenced by:
                                          */
  real_T PulseGenerator1_Amp;          /* Expression: 20
                                        * Referenced by: '<Root>/Pulse Generator1'
                                        */
  ...
  real_T Gain6_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T DiscreteFilter2_NumCoef[2];   /* Expression: [1 -1]
                                        * Referenced by: '<Root>/Discrete Filter2'
                                        */
  real_T DiscreteFilter2_DenCoef;      /* Expression: [Te2]
                                        * Referenced by: '<Root>/Discrete Filter2'
                                        */
...
struct tag_RTM_Implantation_Cmd_LQI_T {
  const char_T *path;
...
extern P_Implantation_Cmd_LQI_T Implantation_Cmd_LQI_P;

/* Block signals (default storage) */
extern B_Implantation_Cmd_LQI_T Implantation_Cmd_LQI_B;

/* Continuous states (default storage) */
extern X_Implantation_Cmd_LQI_T Implantation_Cmd_LQI_X;

/* Block states (default storage) */
extern DW_Implantation_Cmd_LQI_T Implantation_Cmd_LQI_DW;
...
extern void Implantation_Cmd_LQI_initialize(void);
extern void Implantation_Cmd_LQI_output0(void);
extern void Implantation_Cmd_LQI_update0(void);
extern void Implantation_Cmd_LQI_output2(void);
extern void Implantation_Cmd_LQI_update2(void);
extern void Implantation_Cmd_LQI_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Implantation_Cmd_LQI_rtModel *Implantation_Cmd_LQI(void);
...
extern RT_MODEL_Implantation_Cmd_LQI_T *const Implantation_Cmd_LQI_M;
 ...
 *
 * '<Root>' : 'Implantation_Cmd_LQI'
 * '<S1>'   : 'Implantation_Cmd_LQI/Quanser Aero USB Interface'
 * '<S2>'   : 'Implantation_Cmd_LQI/Radians to Degrees2'
 * '<S3>'   : 'Implantation_Cmd_LQI/Retour etat w'
 * '<S4>'   : 'Implantation_Cmd_LQI/Quanser Aero USB Interface/Base LED Colour'
 */
#endif                                 /* RTW_HEADER_Implantation_Cmd_LQI_h_ */
