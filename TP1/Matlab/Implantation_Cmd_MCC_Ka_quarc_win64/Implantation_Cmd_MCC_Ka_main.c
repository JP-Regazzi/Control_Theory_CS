...
typedef RT_MODEL_Implantation_Cmd_MCC_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Implantation_Cmd_MCC_Ka(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Implantation_Cmd_MCC_Ka_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://Implantation_Cmd_MCC_Ka:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Implantation_Cmd_MCC_Ka -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
