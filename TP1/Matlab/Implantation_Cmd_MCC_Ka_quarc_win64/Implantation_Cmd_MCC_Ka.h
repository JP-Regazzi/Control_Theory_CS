...
#ifndef RTW_HEADER_Implantation_Cmd_MCC_Ka_h_
#define RTW_HEADER_Implantation_Cmd_MCC_Ka_h_
#ifndef Implantation_Cmd_MCC_Ka_COMMON_INCLUDES_
#define Implantation_Cmd_MCC_Ka_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                            /* Implantation_Cmd_MCC_Ka_COMMON_INCLUDES_ */

#include "Implantation_Cmd_MCC_Ka_types.h"
...
#define Implantation_Cmd_MCC_Ka_rtModel RT_MODEL_Implantation_Cmd_MCC_T

/* Block signals (default storage) */
typedef struct {
  real_T HILRead_o1;                   /* '<S1>/HIL Read' */
  real_T HILRead_o2;                   /* '<S1>/HIL Read' */
  real_T omega_refrads;                /* '<Root>/Add1' */
  real_T Gain2[2];                     /* '<Root>/Gain2' */
  real_T u4V;                          /* '<Root>/+//- 24V' */
  real_T Gain;                         /* '<S2>/Gain' */
  real_T Clock;                        /* '<Root>/Clock' */
} B_Implantation_Cmd_MCC_Ka_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T Integrateur1_states;          /* '<Root>/Integrateur1' */
  ...
  real_T Integrateur1_tmp;             /* '<Root>/Integrateur1' */
...
} DW_Implantation_Cmd_MCC_Ka_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Implantation_Cmd_MCC_Ka_B
#define BlockIO                        B_Implantation_Cmd_MCC_Ka_T
#define rtP                            Implantation_Cmd_MCC_Ka_P
#define Parameters                     P_Implantation_Cmd_MCC_Ka_T
#define rtDWork                        Implantation_Cmd_MCC_Ka_DW
#define D_Work                         DW_Implantation_Cmd_MCC_Ka_T

/* Parameters (default storage) */
struct P_Implantation_Cmd_MCC_Ka_T_ {
  ...
  real_T Pitchcountstodeg_Gain;        /* Expression: 2*pi/512/4
                                        ...
                                        */
  real_T PulseGenerator_Amp;           /* Expression: 150*2
  ...
  real_T Gain2_Gain;                   /* Expression: 2*pi/2048
                                        ...
                                        */
  real_T Integrateur1_NumCoef[2];      /* Expression: [Te1 0]
                                        * Referenced by: '<Root>/Integrateur1'
                                        */
  real_T Integrateur1_DenCoef[2];      /* Expression: [1 -1]
                                        * Referenced by: '<Root>/Integrateur1'
                                        */
  real_T Integrateur1_InitialStates;   /* Expression: 0
                                        * Referenced by: '<Root>/Integrateur1'
                                        */
...
struct tag_RTM_Implantation_Cmd_MCC__T {
  const char_T *path;
...
extern P_Implantation_Cmd_MCC_Ka_T Implantation_Cmd_MCC_Ka_P;

/* Block signals (default storage) */
extern B_Implantation_Cmd_MCC_Ka_T Implantation_Cmd_MCC_Ka_B;

/* Block states (default storage) */
extern DW_Implantation_Cmd_MCC_Ka_T Implantation_Cmd_MCC_Ka_DW;

/* Model entry point functions */
extern void Implantation_Cmd_MCC_Ka_initialize(void);
extern void Implantation_Cmd_MCC_Ka_output(void);
extern void Implantation_Cmd_MCC_Ka_update(void);
extern void Implantation_Cmd_MCC_Ka_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Implantation_Cmd_MCC_Ka_rtModel *Implantation_Cmd_MCC_Ka(void);
...
extern RT_MODEL_Implantation_Cmd_MCC_T *const Implantation_Cmd_MCC_Ka_M;
 ...
 *
 * '<Root>' : 'Implantation_Cmd_MCC_Ka'
 * '<S1>'   : 'Implantation_Cmd_MCC_Ka/Quanser Aero USB Interface'
 * '<S2>'   : 'Implantation_Cmd_MCC_Ka/Radians to Degrees2'
 * '<S3>'   : 'Implantation_Cmd_MCC_Ka/Quanser Aero USB Interface/Base LED Colour'
 */
#endif                               /* RTW_HEADER_Implantation_Cmd_MCC_Ka_h_ */
