###########################################################################
## Makefile generated for component 'Implantation_Cmd_MCC_Ka'. 
## 
## Makefile     : Implantation_Cmd_MCC_Ka.mk
## Generated on : Thu Oct 19 10:17:56 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Implantation_Cmd_MCC_Ka.rt-win64
...
PRODUCT_NAME              = Implantation_Cmd_MCC_Ka
MAKEFILE                  = Implantation_Cmd_MCC_Ka.mk
...
COMPILER_COMMAND_FILE     = Implantation_Cmd_MCC_Ka_comp.rsp
CMD_FILE                  = Implantation_Cmd_MCC_Ka.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Implantation_Cmd_MCC_Ka.rt-win64
...
DEFINES_STANDARD = -DMODEL=Implantation_Cmd_MCC_Ka -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka.c $(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka_data.c $(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka_main.c $(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rtGetInf.c $(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rtGetNaN.c $(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Implantation_Cmd_MCC_Ka.obj Implantation_Cmd_MCC_Ka_data.obj Implantation_Cmd_MCC_Ka_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Implantation_Cmd_MCC_Ka.obj : "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka.c"


Implantation_Cmd_MCC_Ka_data.obj : "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka_data.c"


Implantation_Cmd_MCC_Ka_main.obj : "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\Implantation_Cmd_MCC_Ka_main.c"


rtGetInf.obj : "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Implantation_Cmd_MCC_Ka_quarc_win64\rt_nonfinite.c"
